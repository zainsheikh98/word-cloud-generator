...
const Form = () => {
  ...
  return (
    <>
      ...
      <form
        action={handleSubmit}
        className="container py-5 lg:py-24 text-gray-600 body-font w-full lg:w-[50%] flex flex-row justify-center"
      >
        <div className="bg-gray-100 rounded-lg px-2 py-8 lg:py-8 lg:px-8 flex flex-col mx-auto w-full mt-10 md:mt-0">
